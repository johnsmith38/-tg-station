...
/obj/item/clothing/tie/armband/bridge/sec
	name = "bridge security armband"
	desc = "An armband, worn by the station's bridge crew to display which department they're assigned to. This one is fancy and red!"
	icon_state = "redband"
	item_color = "redband"

/obj/item/clothing/tie/armband/bridge/engine
	name = "engineering armband"
	desc = "An armband, worn by the station's bridge crew to display which department they're assigned to. This one is orange with a reflective strip!"
	icon_state = "engieband"
	item_color = "engieband"

/obj/item/clothing/tie/armband/bridge/med
	name = "medical armband"
	desc = "An armband, worn by the station's bridge crew to display which department they're assigned to. This one is white with a blue strip!"
	icon_state = "medblueband"
	item_color = "medblueband"

/obj/item/clothing/tie/armband/bridge/cargo
	name = "cargo armband"
	desc = "An armband, worn by the station's bridge crew to display which department they're assigned to. This one is brown. How boring."
