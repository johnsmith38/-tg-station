...
/obj/item/device/radio/headset/heads/bcomm
	name = "\proper the bridge commander's headset"
	desc = "The headset of the guy who shouts at everyone. \nTo access the command channel, use :c."
	flags = EARBANGPROTECT
	icon_state = "com_headset_alt"
	item_state = "com_headset_alt"
	keyslot = new /obj/item/device/encryptionkey/headset_com

/obj/item/device/radio/headset/heads/bcrew
	name = "bridge crew's headset"
	desc = "A headset used by Bridge Crewmen."
	icon_state = "bridge_heatset"
	item_state = "headset"
